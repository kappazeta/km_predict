...
class DataGenerator(Sequence):
    def __init__(self, list_indices, path_input, batch_size, features, tile_size, num_classes, product_level,
        ...
        if product_level == "L2A":
            self.stds = [7.97896597e-05, 1.96106872e-02, 1.93976965e-02, 1.84422729e-02, 1.85926837e-02, 1.92165235e-02, 1.91702730e-02, 1.93807328e-02, 2.04439914e-02, 1.93582799e-02, 2.88021533e-02, 1.51309074e-02, 1.35563877e-02, 2.19992385e-03]
            self.means = [0.00184475, 0.02789634, 0.02687363, 0.027595, 0.02618538, 0.03201396, 0.04303698, 0.0465746 , 0.04868418, 0.04867476, 0.06553151, 0.03083546, 0.0231002 , 0.01946491]
