...
```
If the prediction for the same product is running multiple times and .CVAT folder is created under /date, it might be convenient to disable sub_tiling procedure for the next run by -tiling False
```
